    ...
    <div>
              ...
              return (
                <div>
                  <UpcomingCourseCard
                    key={index}
                    href={`/course`}
                    src="https://www.startdesigns.com/blog/wp-content/uploads/2021/08/Primary-Front-End-Web-Development-Tools-2.jpg"
                    alt="imgPoster"
                    level="Beginner"
      ...
      >
        <div className="text-center">
          <h1 className="p-[15px] text-lg font-bold">The ​Learning Digital</h1>
        ...
        <div className="flex w-full items-center justify-center gap-x-40 max-sm:flex-col sm:flex-col md:flex-col lg:flex-row">
          <div className="flex h-[100%] flex-col justify-center p-7 sm:w-[100%] md:w-[100%] lg:w-[50%] lg:p-0">
            ...
            <p>
              ...
              most innovative companies developing real-world digital education,
              empowering many professionals and some of the largest corporations
              in the world.
            </p>
          </div>
                ...
                return (
                  <div>
                    ...
                    <p className="ml-[15px] p-[10px]">
                      Our cutting-edge curriculum is developed and taught by the
                      world's best digital experts and professionals.
                    </p>
                  </div>
                );
              })}
