...
export default function Login({ src, title, desc }: Props) {
    const router = useRouter();
    return (
        <div className="flex justify-center p-4">
            <div className=" mb-12 md:mb-0 md:w-8/12 lg:w-5/12 xl:ml-20 xl:w-5/12">
                {/* introduction about website reancode101 */}
                <div className="">
                    ...
                    <h5 className="mb-2 text-center text-xl font-medium uppercase leading-tight  text-gray-900">
                        Log in to your ReanCode101 account !
                    </h5>
                    <p className=" mb-2 text-base text-gray-700">
                        You can browse the various lessons and levels without an account, but you will need to sign in to save your progress and projects.
                    </p>
                </div>
                ...
                <div className="... flex justify-between">
                    <button
                        onClick={() => router.push("/auth/recoveryPassword")}
                        className="text-[#118AEF] mt-2 mb-0 pt-1 text-sm"
                        type='button'
                    >
                        Forget Password ?
                    </button>
